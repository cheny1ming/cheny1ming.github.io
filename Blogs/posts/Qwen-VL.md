...
---
Qwen系列的多模态大模型为我们理解多模态大模型提供了很好的insights。截止到目前为止，Qwen-VL系列已经更新到了Qwen3-VL，经过了好几轮的迭代，Qwen3-VL已经成为非常不错的视觉-语言模型了。为了更好地了解Qwen系列的多模态大模型，我决定从Qwen-VL，他的第一代讲起，来了解他的全面更新发展过程。
